...
| [07](07-decoder.md) | `src/decoder.py` | Thin public entry point |
| [08](08-output.md) | `src/output.py` | Validate against schema + write file |
| [09](09-main.md) | `src/__main__.py` | CLI and orchestration |
